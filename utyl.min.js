...
var RGBA=function(a,b,c,d){this.set(a,b,c);this.alpha=d};RGBA.inherits(RGB);Math.randomRange=function(a,b){return Math.floor(Math.random()*(b-a))+a};Timer=function(a,b,c){function d(){if(void 0==c)var b=(new Date).getTime()-f-g*e;(g++<c||!a(b/e+1))&&setTimeout(d,e-b)}var e=1E3/b,g=0,f=0;setTimeout(function(){f=(new Date).getTime();d()},e)};"undefined"!=typeof document&&(document.host=document.URL.split("/")[2].split(":")[0]);
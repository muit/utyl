Utyl={author:"muitxer",repo:"http://github.com/muit/utyl",version:"0.3.6-b"};String.prototype.startsWith=function(a){return this.slice(0,a.length)==a};String.prototype.endsWith=function(a){return-1!==this.indexOf(a,this.length-a.length)};String.prototype.contains=function(a){return-1!=this.indexOf(a)};String.random=function(a){a=a||8;return Math.random().toString(36).substring(a)};Object.keys=function(a){var b=[],c;for(c in a)Object.prototype.hasOwnProperty.call(a,c)&&b.push(c);return b};

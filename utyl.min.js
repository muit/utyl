...
var RGBA=function(a,b,c,d){this.set(a,b,c);this.alpha=d};RGBA.inherits(RGB);Math.randomRange=function(a,b){return Math.floor(Math.random()*(b-a))+a};Timer=function(a,b,c){function d(){if(!(c&&g++>=c)){e=(new Date).getTime();var b=e-last-f;0>b&&(b=0);last=e;a(b/f+1)||setTimeout(d,f-b)}}var f=1E3/b,g=0,e=0;setTimeout(function(){last=(new Date).getTime();d()},0)};"undefined"!=typeof document&&(document.host=document.URL.split("/")[2].split(":")[0]);